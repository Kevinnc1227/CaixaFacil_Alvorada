    ...
    const saveMutation = useMutation({
        mutationFn: async () => {
            ...
            const payload = {
                ...
                qtdEstoque: Number.parseInt(String(form.qtdEstoque)) || 0,
                qtdMinima: Number.parseInt(String(form.qtdMinima)) || 0,
            };
            if (editTarget) {
    ...
    const ajustarMutation = useMutation({
        mutationFn: async () => {
            ...
            return api.post(`/produtos/${ajusteModal.id}/estoque`, {
                quantidade: Number.parseInt(ajusteQtd),
                tipo: ajusteTipo,
                    ...
                    <div className="bg-surface rounded-2xl border border-outline-variant shadow-2xl w-full max-w-lg">
                        ...
                        <div className="p-md flex flex-col gap-md">
                            <div className="flex flex-col gap-xs">
                                <label htmlFor="est-nome" className="font-label-bold text-on-surface text-sm">Nome do Produto *</label>
                                <input
                                    id="est-nome"
                                    className="input"
                            ...
                            <div className="flex gap-md">
                                <div className="flex flex-col gap-xs flex-1">
                                    <label htmlFor="est-qtd" className="font-label-bold text-on-surface text-sm">Qtd. Inicial em Estoque</label>
                                    <input
                                        id="est-qtd"
                                        className="input"
                                        type="number"
                                ...
                                <div className="flex flex-col gap-xs flex-1">
                                    <label htmlFor="est-qtd-min" className="font-label-bold text-on-surface text-sm">Qtd. Mínima (alerta)</label>
                                    <input
                                        id="est-qtd-min"
                                        className="input"
                                        type="number"
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-surface rounded-2xl border border-outline-variant shadow-2xl w-full max-w-sm">
                        ...
                        <div className="p-md flex flex-col gap-md">
                            ...
                            <div className="flex flex-col gap-xs">
                                <label htmlFor="ajuste-qtd" className="font-label-bold text-on-surface text-sm">Quantidade *</label>
                                <input
                                    id="ajuste-qtd"
                            ...
                            <div className="flex flex-col gap-xs">
                                <label htmlFor="ajuste-motivo" className="font-label-bold text-on-surface text-sm">Motivo (opcional)</label>
                                <input
                                    id="ajuste-motivo"
                                    className="input"
                        ...
                        <div className="flex gap-md p-md border-t border-outline-variant">
                            ...
                            <button
                                ...
                                disabled={!ajusteQtd || Number.parseInt(ajusteQtd) <= 0 || ajustarMutation.isPending}
