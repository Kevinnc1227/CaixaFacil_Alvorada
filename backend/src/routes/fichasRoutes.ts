...
import { listClientes, createCliente, getFichasByCliente, fecharFicha, createFicha, listTodasFichas, deleteCliente, updateCliente } from '../controllers/fichasController';
...
router.get('/abertas/lista', authenticate, listTodasFichas);
...
// Edição e Exclusão de cliente (requer validação de admin no controller)
